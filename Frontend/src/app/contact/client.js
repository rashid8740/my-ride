...
// Custom styling for form inputs to ensure text visibility
const inputStyle = {
  caretColor: "#f97316", // Orange-500 caret color
};
  ...
  return (
    <div className="mb-4">
      ...
      <input
        ...
        required={required}
        style={inputStyle}
        className="w-full px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 focus:outline-none transition-all shadow-sm"
      />
    </div>
  );
};
    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <select
          ...
          onChange={onChange}
          required={required}
          className="w-full appearance-none px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 focus:outline-none transition-all shadow-sm"
          style={{ 
            caretColor: "#f97316", 
        ...
        <section className="relative h-[40vh] min-h-[300px] w-full bg-gray-900">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white z-10 px-4">
              ...
              <p className="text-xl max-w-2xl mx-auto drop-shadow-sm">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12">
              {/* Contact Information */}
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 relative">
                  <span className="relative z-10 inline-block after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[6px] after:w-12 after:bg-orange-500/30 after:-z-10">Get In Touch</span>
                </h2>
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 relative">
                  <span className="relative z-10 inline-block after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[6px] after:w-12 after:bg-orange-500/30 after:-z-10">Send Us a Message</span>
                </h2>
        ...
        <section className="bg-gray-50 py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 relative">
                <span className="relative z-10 inline-block after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:mx-auto after:h-[6px] after:w-16 after:bg-orange-500/30 after:-z-10">Find Us</span>
              </h2>
